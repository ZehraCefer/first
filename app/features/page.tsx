...
const features: Feature[] = [
  ...
  },
  {
    ...
    subheading:
      "Our platform is dedicated to providing you with a wealth of information on social casino games, covering everything from gameplay mechanics to special features. Discover detailed reviews, in-depth guides, and up-to-date information on the latest trends in the world of social casino gaming. With our resources, you can explore various game options without any need for real-money investments, helping you make informed decisions and find the best games to suit your interests.",
  },
  {
    ...
    <section className={styles.container} id="features-section">
      <div className={styles.intro}>
        ...
        <p className={styles.description}>
          At yourgamedestination.org, we are committed to delivering the highest standards of security and user experience. Our mission is to provide you with reliable information about social casino games while ensuring your data remains safe. With a focus on user education and transparency, we aim to be your trusted partner in exploring the vibrant world of social gaming.
        </p>
      </div>
