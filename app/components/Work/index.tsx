...
const Home = () => {
  const game = {
    ...
    heading: "Spin & Win: The Ultimate Slot Adventure",
    subheading: "Embark on a whimsical journey with hilarious characters!",
    hiddenPara:
      "Dive into a colorful world filled with animated friends and thrilling slot spins. Discover exciting rewards and challenge quirky foes who are after your jackpot!",
  };
