    ...
    <div className={styles.container}>
      ...
      <div className={styles.simpleSection}>
        ...
        <h3 className={styles.sectionTitle}>
          Discover and Enjoy the Best Social Casino Games!
        </h3>
        <p className={styles.sectionText}>
          Dive into an endless world of entertainment with our comprehensive reviews of leading social casino games.
        </p>
        <p className={styles.sectionText}>
          From the latest hits to classic favorites, find games that promise hours of fun—all without spending a dime.
        </p>
        <p className={styles.sectionText}>
